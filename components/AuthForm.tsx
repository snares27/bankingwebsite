...
const AuthForm = ({type}: {type:string}) => {
    ...
    <section className='auth-form'>
        ...
        <Link href="/" className='cursor-pointer flex items-center gap-1'>
                ...
                alt="SebNa Logo"
                />
                <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>SebNa</h1>

                </Link>
                <div className='flex flex-col gap-1 md:gap-3'>
                    <h1 className='text-24 lg:tet-36 font-semibold text-gray-900'>
                        {user
                            ? 'Link Account'
                            : type === 'sign-in'
                                ? 'Sign In'
                    ...
                    {type === 'sign-up'&& (
                        <>
                            ...
                            <div className='flex gap-4'>
                                ...
                                label="State" placeholder='Example: TX' />
                                <CustomInput control={form.control} name='postalCode' 
                                label="Postal Code" placeholder='11101' />
                            </div>
                            <div className='flex gap-4'>  
